    ...
    function buildHubLevelPortals(floors, realms) {
      const clusterPoints = {
        ...
        mountains: [[34.5, 7], [35.5, 5.5], [37, 5], [38.5, 5.5], [39.5, 7]],
        ...
        desertTemple: [[46.75, 13], [47.75, 13.5], [48.25, 14.5], [47.75, 15.5], [46.75, 16.5]],
        ice: [[49.5, 24], [50.25, 25], [50.75, 26], [50.25, 27], [49.5, 28]],
        dream: [[50.25, 34], [50.75, 35], [50.75, 36], [50, 37], [48.75, 37.5]],
        bossShard: [[28, 13.5]],
        runestone: [[28, 23.5]],
    ...
    function transformSageQueue(currentQueue, element) {
      ...
      if (queue.includes("steam")) {
        ...
        if (element === "water") {
          return splitCombinedElement(queue, "steam", "water", "Water condensed Steam, leaving Water.");
        }
      }
